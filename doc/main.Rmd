...
setwd("C:/Users/yftang/Documents/GitHub/Spr2017-proj4-team-5/doc")
...
```{r}
AKumar <- data.frame(scan("C:/Users/yftang/Documents/GitHub/Spr2017-proj4-team-5/data/nameset/AKumar.txt",
...
Letâ€™s first create a vocabulary-based DTM. Here we collect unique terms from all documents and mark each of them with a unique ID using the  `create_vocabulary()` function. We use an iterator to create the vocabulary.
```{r}
